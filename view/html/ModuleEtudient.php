...
<body>
    ...
    <div class="bodyOfPage">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="text-right">
                    <a href="#" class="btn btn-danger">Informations are wrong ? Push this button</a>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                <h3 class="card-title">Your module results</h3>
                <table class="table table-striped table-bordered">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th scope="col">Make up test</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <th style="width:25%">Maths</th>
