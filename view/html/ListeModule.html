...
<body>
    ...
    <div class="bodyOfPage">
        ...
        <div class="card">
            <div class="card-body">
                <h3 class="card-title">Module list <i>(click on one module to see his informations)</i></h3>
                <table class="table table-striped table-bordered">
                    <thead class="thead-dark">
                        <tr>
                            <th scope="col">Module number</th>
                            <th scope="col">Name module</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <th>1</th>
                            <td>Legal Ethical Social and Professional</td>
                        </tr>
                        <tr>
                            <th>2</th>
                ...
                <div class="text-center">
                    <a href="#" class="btn btn-lg btn-info">Add a new fucking module</a>
                </div>
            </div>
        </div>
    </div>
