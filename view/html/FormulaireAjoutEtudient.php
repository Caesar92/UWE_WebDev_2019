...
<body>
    ...
    <div class="bodyOfPage">
        ...
        <div class="card">
            <div class="card-body">
                <h3 class="card-title">Formular to add a student at a module</h3>
                <form>
                    <div class="form-group">
                        <div class="form-group col-md-12">
                            ...
                            <select id="inputState" class="form-control">
                                ...
                                <option>Ptiripou</option>
                                <option>Captain Olivio</option>
                            </select>
                        </div>
                        <div class="form-group col-md-12">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12 text-center">
                            <button type="submit" class="btn btn-lg btn-info">Add this student at this module</button>
                        </div>
                    </div>
                </form>
            </div>
